...
var dbase_operation_Item = {
    ...
    UpdateReturnedItem: function (itemidArray, headercode_details) {
        //alert(itemidArray);
       // alert(headercode_details);
        $.ajax({
...
var show_modal = {
    ...
    // modal for return items //
    confirmationModal_returnItem: function (title, message, status) {
       $("#form_modal_returnslip_details").css('z-index', '10000');
        ...
        modal += '<button type="button" class="btn btn-default" data-dismiss="modal" id="RS_confirm_modal">No</button>';
        modal += '<button type="button" class="btn btn-success" data-dismiss="modal" id="cmdReturnItem">Yes</button>';
        modal += '</div>';
   ...
   // confirmation modal //
    ...
    show_Itemdetails_returnslip: function (returnslip_code) {
        ...
        modal += 'grid-selection-mode="checkbox"';
        ...
        modal += '<div class="modal-footer">';
        modal += '<button type="button" class="btn btn-default" data-dismiss="modal">No</button>';
        modal += '<button type="button" class="btn btn-success" id="cmdReturn">Return</button>';
        modal += '</div>';
...
//    //$("#chkItemReturn").each(function () {
//    //    if ($(this).is(":checked")) {

//    //        arrayitemforreturn.push(itemforreturn.id_number);
//    //        document.getElementById("print").disabled = false;

//    //        alert(arrayitemforreturn);
//    //    }
...
$(document).delegate('#cmdReturn', 'click', function () {
    ...
    //}
    //alert(item_id_arr);
    //dbase_operation_Item.UpdateReturnedItem(item_id_arr, itemforreturn.header_code_string);
